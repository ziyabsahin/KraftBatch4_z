...
public class C02_String_Intro {
    public static void main(String[] args) {
        String str1="hello"; //literal yolla, heap memoryde String poolda oluştu
        String str2="hello"; //poola baktı ve ordaki herlloyu işaret ediyor

        String str3="Hello"; //literal yolla, heap memoryde String poolda oluştu
        ...
        bl=str1==str2;   //String poolda oldugu için true döndü, referanslara bakıyor ==
